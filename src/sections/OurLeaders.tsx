...
const OurLeaders = () => {
  return (
    ...
    {/* <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 place-items-center w-full bg-red-400'> */}
      ...
      {/* Middle Card */}
      <div className='border shadow-md p-4 border-gray-200 h-full max-w-[!400px] w-[300px] sm:w-[320px]'>
       
          {/* Add content here */}
        
            elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis. Class
            aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos
            himenaeos. Curabitur tempus urna at turpis condimentum lobortis. Ut commodo
            Rorem ipsum dolor sit amet, consectetur adipiscing elit.
            Curabitur tempus urna at turpis condimentum lobortis. Ut commodo Rorem ipsum
